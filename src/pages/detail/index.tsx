    ...
    return (
        <div className="w-[90%] m-[auto] max-w-[1100px]" >
            ...
            <div className="w-[90%] max-w-[600px] m-[auto]" >
                <Link to="/" className="bg-[#4CAFEB] px-[16px] py-[14px] rounded-[10px] font-semibold">
                    Back
                </Link>
                {pokemon.data && (
                        ...
                        <div className="pt-5 bg-[#253641] rounded-[20px] p-[16px] my-[20px]">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-[20px] gap-y-[30px]">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-1 gap-[10px] mt-[10px] justify-items-start">

                                        {pokemon.data.abilities.map((item) => {
                                            return (
                                                <div className={`bg-[#4CAFEB] px-[14px] capitalize py-1 rounded-[16px] `} >
                                                    {item.ability.name}
                                                </div>
                                            )
                                        })}
